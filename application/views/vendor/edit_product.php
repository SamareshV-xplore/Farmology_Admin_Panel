      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start --> 
            <form method="post" role="form" action="<?php echo base_url('vendors/edit_submit') ?>" id="product-form" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="crop[]" id="crop" class="form-control" multiple="">
                    ...
                    if(count($crop_list) > 0)
                    {
                      ...
                      {
                        ?>
                        <option value="<?php echo $row['id']; ?>" <?php if(in_array($row['id'], $selected_cropid)) { ?> selected="selected" <?php } ?> ><?php echo $row['title']; ?></option>
                        <?php
                      }
                    }
                    ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="cate[]" multiple="" id="cate1" class="form-control">
                    ...
                    if(count($main_parent) > 0)
                    {
                      ...
                      {
                        ?>
                        <option value="<?php echo $parent_row['id']; ?>" <?php if(in_array($parent_row['id'], $selected_cateid)) { ?> selected="selected" <?php } ?> ><?php echo $parent_row['title']; ?></option>
                        <?php
                      }
                    }
                    ?>
                  ...
                  <div class="col-md-6 option_div" id="div_<?=$option_id?>">
                    ...
                    <div class="box box-solid with-border">
                      ...
                      <div class="box-body">
                        ...
                        <div class="col-md-6 form-group">
                          <label>State List<span class="required_cls">*</span></label>
                          <select class="form-control" name="state_id[]" id="state_id_<?=$option_id?>">
                            <option value="">Select state</option>
                            <?php foreach($state_actual_list as $key_st => $state_row) {?>
                              <option value="<?=$state_row['id']?>" <?php if($option_row['state_id'] == $state_row['id']) { ?> selected="selected" <?php } ?>><?php echo $state_row['state']; ?></option>
                            <?php }?>  
                          </select>
                        </div>
                      </div>
