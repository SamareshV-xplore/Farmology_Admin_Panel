  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <ul class="treeview-menu">
          ...
          <li class="<?php if($navigation == 'referrals') { ?>active<?php } ?>">
              <a href="<?php echo base_url('referrals'); ?>">
                  <i class="fa fa-circle-o text-aqua"></i> <span>Users Referrals Data</span>
              </a>
          </li>
          ...
          <li class="treeview <?php if($navigation == 'delivery_drivers' || $navigation == 'delivery_date_management') { ?>active<?php } ?>">
            <a href="#">
              <i class="fa fa-circle-o text-aqua"></i> <span>Delivery Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="<?php if($navigation == 'delivery_drivers' && $sub_navigation == 'delivery_drivers_list') { ?>active<?php } ?>"><a href="<?=base_url('delivery-drivers-list')?>"><i class="fa fa-circle-o"></i> Delivery Drivers</a></li>
              ...
              <li class="<?php if($navigation == 'delivery_date_management') { ?>active<?php } ?>"><a href="<?=base_url('delivery-date-management')?>"><i class="fa fa-circle-o"></i> Delivery Dates</a></li>
            </ul>
          </li>


          <li class="treeview <?php if($navigation == 'blog' || $navigation == 'blogcat') { ?>active<?php } ?>">
              <a href="#">
          ...
          <a href="#">
            <i class="fa fa-circle-o text-aqua"></i> <span>Video Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview <?php if($navigation == 'questions' || $navigation == 'communities') { ?>active<?php } ?>">
            <a href="#">
                <i class="fa fa-circle-o text-aqua"></i> <span>Q&A Management</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
              <li class="<?php if($navigation == 'communities') { ?>active<?php } ?>">
                  <a href="<?php echo base_url('communities-list'); ?>">
                      <i class="fa fa-circle-o text-aqua"></i> <span>Asked Community Questions</span>
                  </a>
              </li>
              <li class="<?php if($navigation == 'questions' && $sub_navigation == 'questions-list') { ?>active<?php } ?>"><a href="<?php echo base_url('questions-list');?>"><i class="fa fa-circle-o"></i> Asked Expert Questions</a></li>
        ...
        <li class="treeview <?php if($navigation == 'push' || $navigation == 'schedule-push-notification') { ?>active<?php } ?>">
          <a href="#">
              <i class="fa fa-circle-o text-aqua"></i> <span>Notification Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li class="<?php if($navigation == 'push') { ?>active<?php } ?>">
                <a href="<?php echo base_url('push-notification'); ?>">
                    <i class="fa fa-circle-o text-aqua"></i> <span>Send Push Notification</span>
                </a>
            </li>
        ...
        <li class="treeview <?php if($navigation == 'merchants' || $navigation == 'merchants_commision' || $navigation == 'merchant_earned_commissions') { ?>active<?php } ?>">
          <a href="#">
              <i class="fa fa-circle-o text-aqua"></i> <span>Merchant Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="<?php if($navigation == 'merchants_commision') { ?>active<?php } ?>">
                <a href="<?php echo base_url('merchants/commission'); ?>">
                    <i class="fa fa-circle-o text-aqua"></i> <span>Set Merchant Commission</span>
                </a>
            </li>
        ...
        <li class="treeview <?php if($navigation == 'code_generator' || $navigation == 'service-coupons') { ?>active<?php } ?>">
          <a href="#">
              <i class="fa fa-circle-o text-aqua"></i> <span>Coupons Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li class="<?php if($navigation == 'code_generator') { ?>active<?php } ?>">
                <a href="<?php echo base_url('code_generator/'); ?>">
                    <i class="fa fa-circle-o text-aqua"></i> <span>Product Coupons</span>
                </a>
            </li>
        ...
        <li class="treeview <?php if($navigation == 'code_generator' || $navigation == 'service-coupons') { ?>active<?php } ?>">
          <a href="#">
              <i class="fa fa-circle-o text-aqua"></i> <span>Services Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li class="<?php if($navigation == 'field_req') { ?>active<?php } ?>">
                <a href="<?php echo base_url('field-visit-request'); ?>">
                    <i class="fa fa-circle-o text-aqua"></i> <span>Field Visit Requests</span>
                </a>
            </li>
