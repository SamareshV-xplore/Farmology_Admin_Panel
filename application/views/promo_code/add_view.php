      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="<?php echo base_url('promo_code_management/add_submit') ?>" id="promo-code-form">
              <input type="hidden" name="promo_code_form" value="1">
              <div class="box-body">
                  <div class="form-group col-md-6">
                  <label for="first_name">Promo Code<span class="required_cls">*</span></label>
                  <input type="text" class="form-control" id="promo_code" name="promo_code" placeholder="Promo Code" onblur="checkCouponCode()">
                  ...
                  <label for="last_name" >Description</label>
                    <input type="text" class="form-control" id="promo_description" name="promo_description" placeholder="Description" >
                </div>
                  <div class="form-group col-md-6">
                      <label for="first_name">Eligible Order Total Price</label>
                      <input type="text" class="form-control" id="eligible_order_price" name="eligible_order_price" placeholder="Eligible Order Price" >
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="usage_count" name="usage_count" placeholder="Max Number of Usage" >
                  ...
                  <div class="form-group col-md-6" id="check_discount">
                      ...
                      <input type="text" class="form-control" id="discount_limit" name="discount_limit" placeholder="Discount Limit" >
                      <span style="color: red;" id="discount_limit_err" class="clearfix"></span>
                      <input type="hidden" id="the_discount_status" value="1">
                  </div>
                  <div class="form-group col-md-6" id="max_discount_div">
                      <label for="first_name">Max Discount Amount<span class="required_cls">*</span></label>
                      <input type="text" class="form-control" id="max_limit" name="max_limit" placeholder="Max Discount Amount" >                    
                  </div>
                  <div class="clearfix"></div>
                  <div class="form-group col-md-6">
                      <label for="blood_group">Assign to specific User</label>
                      <select class="form-control" name="user_specific" id="user_specific">
                          <option value="N">No</option>
                          <option value="Y">Yes</option>
                      </select>
                  </div>
                  <div class="col-md-6" id="mobile_number" style="display: none;">
                      ...
                      <div class="form-inline form-group">
                          ...
                          <input type="text" class="form-control" id="mobile" name="mobile" placeholder="10 Digit Mobile Number" >
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary pull-right" onclick="return add_promo_submit();">Create Promo Code</button>
  ...
  <script type="text/javascript">
    ...
    function add_promo_submit()
    {
      ...
      if(promo_code == '' )
      {
        ...
        {
            $("#usage_count_err").text('Please provide valid usages count. Only numbers accepted.');
