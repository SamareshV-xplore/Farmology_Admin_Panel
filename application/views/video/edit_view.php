      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="<?php echo base_url('video/edit_submit') ?>" id="video-form" enctype="multipart/form-data">
              <input type="hidden" name="video_form" value="1">
              <input type="hidden" name="video_id" value="<?php echo $video_details['id']; ?>">
              <div class="box-body">            

                <div class="form-group col-md-12">
                  <label for="title">Title<span class="required_cls">*</span></label>
                  <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?php echo $video_details['title']; ?>" >
								</div> 
								
								<div class="form-group col-md-12">
                  <label for="last_name" >Description<span class="required_cls">*</span></label>
                  <textarea name="description" id="description" class="form-control"><?php echo $video_details['description']; ?></textarea>
                </div>
                  ...
                  <input type="text" class="form-control" id="yt_video_id" name="yt_video_id" placeholder="eg: 7n47zBdQ6qg" value="<?php echo $video_details['yt_video_id']; ?>" >
								</div>
								
								<div class="form-group col-md-6">
                  <label for="blood_group">Status<span class="required_cls">*</span></label>
                  <select class="form-control" name="status" id="status">
                    <option value="Y" <?php if($video_details['status'] == 'Y') { ?> selected="selected" <?php } ?> >Active</option>
                    <option value="N" <?php if($video_details['status'] == 'N') { ?> selected="selected" <?php } ?> >Inactive</option>
                  </select>
								</div>
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary pull-right" onclick="return upload_video_submit();">Update Video</button>
