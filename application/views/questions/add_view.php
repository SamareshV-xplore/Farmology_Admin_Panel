      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="<?php echo base_url('questions/add_submit') ?>" id="question-form" enctype="multipart/form-data">
              <input type="hidden" name="question_form" value="1">
              <div class="box-body">
               
                <div class="form-group col-md-12">
                  <label for="question_images" class="btn btn-primary image_input_label">Upload Question Image</label>
                  <input type="file" id="question_images" name="question_images[]" multiple="multiple" accept="image/*" style="display:none;"/>
                  <div class="image_viewer_container d-flex flex-warp"></div>
                </div>
               ...
               <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <textarea class="form-control" id="answer_text" name="answer_text" placeholder="Answer"></textarea>
                  </div>
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary pull-right" onclick="return add_question_submit();">Add</button>

                <a href="<?php echo base_url('questions-list'); ?>"><button type="button" class="btn btn-default pull-left">Cancel</button></a>
              </div>
            </form>
          </div>
...
<script>
  ...
  {
    $(".image_viewer_container").html("");
    var selected_files_count = input.files.length;
    for (let i=0; i<selected_files_count; i++)
    {
      var file = input.files[i];
      var image_url = URL.createObjectURL(file);
      var image = `<img src="${image_url}" class="image_viewer"/>`;
      $(".image_viewer_container").append(image);
    }
  }

  $("#question_images").on("change", function(){
      var input = document.getElementById("question_images");
      showSelectedImages(input);
  });
