                  ...
                  if(count($banner_list) > 0)
                  {
                    ...
                    foreach($banner_list as $list)
                    {
                      ...
                      <tr>
                        ...
                        <td><img src="<?=FRONT_URL?><?php echo $list['image']; ?>" width="300px"></td>
                        <td>
                          <?php
                            if($list['status'] == 'Y')
                            {
                        ...
                        <td>
                          <a href="<?php echo base_url('banner-edit/'.$list['id']); ?>"><button type="button" class="btn bg-yellow btn-sm" title="Edit Details"><i class="fa fa-edit"></i>
                            </button></a>
                            <a href="<?php echo base_url('banner-delete/'.$list['id']); ?>" onclick="return confirm('Are you sure want to delete this banner?')"><button type="button" class="btn bg-red btn-sm" title="Delete"><i class="fa fa-trash"></i>
                            </button></a>
                        </td>
                      </tr>
                      <?php
