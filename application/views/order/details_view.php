        ...
        <div class="col-sm-4 invoice-col">
         Account Holder:
          <address>
            ...
            <a href="<?=base_url('user-edit/'.$order_details['customer_details']['id'])?>" class="text-center" target="_blank">View Details</a>
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <div class="form-group col-md-12">
                 <button type="button" class="btn btn-primary pull-right" onclick="return update_order_status(<?=$order_details['id']?>);" id="update_btn">Update</button>
                 <br>
