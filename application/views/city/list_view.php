                    ...
                    foreach($city_list as $list)
                    {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <th>
                              <a href="<?php echo base_url('zip-list/'.$list['id']); ?>">
                        ...
                        <td>
                          <a href="<?php echo base_url('city-edit/'.$list['id']); ?>"><button type="button" class="btn bg-yellow btn-sm" title="Edit Details"><i class="fa fa-edit"></i>
                            </button></a>
                            <a href="<?php echo base_url('city-delete/'.$list['id']); ?>" onclick="return confirm('Are you sure want to delete this city?')"><button type="button" class="btn bg-red btn-sm" title="Delete"><i class="fa fa-trash"></i>
                            </button></a>
                        </td>
                      </tr>
                      <?php
