      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="<?php echo base_url('district_management/add_submit')?>" id="district-form" enctype="multipart/form-data">
              <input type="hidden" name="district_form" value="1">
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                      <label for="first_name">District Name<span class="required_cls">*</span></label>
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary pull-right" onclick="return add_district_submit();">Add District</button>
