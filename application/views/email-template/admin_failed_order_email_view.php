...
<table width="100%">
  ...
  <tr>
    <td  width="800px" style="text-align:center; padding:10px; background:red; color: white;">
      <h1>Payment Failed For Order! Order ID: <?=$order_details['order_no']?></h1>      
    </td>    
  </tr>
</table>
...
<table  width="100%" style="margin-top:14px; border:1px solid #ccc;">
    ...
    <b>Total: </b><?=$order_details['order_total']?><br>
