            ...
            <form method="post" role="form" action="<?php echo base_url('category/add_submit') ?>" id="category-form" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="main_parent" id="main_parent" class="form-control" onchange="return get_child_category();" disabled="disabled">
                ...
                <div class="form-group col-md-4">
                  <label for="first_name">Icon<span class="required_cls">*</span></label>
