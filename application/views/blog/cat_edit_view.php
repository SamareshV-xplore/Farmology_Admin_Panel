      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" role="form" action="<?php echo base_url('blog/category_edit_submit') ?>" id="blog-form">
              <input type="hidden" name="blog_form" value="1">
              <input type="hidden" name="blog_cate_id" id="blog_cate_id" value="<?=$blog_cat_details['id']?>">
              <div class="box-body">

                <div class="form-group col-md-6">
                  <label for="cate_title">Title<span class="required_cls">*</span></label>
                  <input type="text" class="form-control" id="blog_title" name="title" placeholder="Blog Category Title" value="<?=$blog_cat_details['title']?>">
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="status" id="status">
                    <option value="Y" <?php if($blog_cat_details['status'] == 'Y')
                    { ?> selected="selected" <?php } ?> >Active</option>
                    <option value="N" <?php if($blog_cat_details['status'] == 'N')
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary pull-right" onclick="return add_blog_category_submit();">Update Blog Category</button>
